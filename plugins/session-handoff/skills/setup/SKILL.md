---
name: setup
description: session-handoff の producer (context 使用率キャッシュの書き出し) を確認・構成する。handoff setup、natsuume-statusline のキャッシュ連携、閾値検知が発火しないときの確認で使う
---

# session-handoff setup — context cache producer の構成
